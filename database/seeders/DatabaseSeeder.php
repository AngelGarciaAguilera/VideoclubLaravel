...
class DatabaseSeeder extends Seeder
{
    ...
    private $films = array(
        array(
            ...
            'poster' => 'https://pics.filmaffinity.com/El_padrino-314610048-large.jpg',
            'rented' => false,
        ...
        array(
            ...
            'poster' => 'https://pics.filmaffinity.com/La_vida_es_bella-646167341-large.jpg',
            'rented' => true,
        ...
        array(
            ...
            'poster' => 'https://pics.filmaffinity.com/Sin_perdaon-854755790-large.jpg',
            'rented' => false,
        ...
        array(
            ...
            'poster' => 'https://pics.filmaffinity.com/La_naranja_mecaanica-964766200-large.jpg',
            'rented' => false,
    ...
    private function seedCatalog() {
        ...
        foreach( $this->films as $film ) {
            ...
            $movie->rented = $film['rented'];
            $movie->synopsis = $film['synopsis'];
            $movie->save();
        }
    }
    ...
    public function seedUser() {
        ...
        $user = new User();
        $user->name = 'Ángel';
        $user->email = 'agaragu0708@g.educaand.es';
        $user->password = bcrypt('garciaaguilera');
        $user->save();
    }
